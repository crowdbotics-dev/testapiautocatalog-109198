...
## Project Structure
    ...
    ├── testapiautocatalog_109198  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_109198`
...
2. Clone this repo and `cd testapiautocatalog_109198`
